...
import { reconstructState, rollupStatus, type PrFacts } from "../core/resume.js";
...
const raw = execFileSync(
  "gh",
  ["pr", "view", pr, "--json", "headRefName,state,reviewDecision,statusCheckRollup"],
...
const reviewMap: Record<string, PrFacts["reviewDecision"]> = {
  APPROVED: "approved",
...
process.stdout.write(
  JSON.stringify({ pr: Number(pr), facts, reconstructed: reconstructState(facts) }, null, 2) + "\n",
);
