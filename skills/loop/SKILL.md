...
| `OPEN_SPEC_PR` | `spec.md` + die **geskippten** Tests als **eigenen Spec-PR** (Bot-Identität) gegen `main` öffnen. Das ist der reviewbare HEAD für den Spec-Review-Stopp (Anker b). Hält `main` grün (Trace zählt Skips, Vitest rötet nicht). |
